 ...
 * - {@link FreeMaterialSetCreateFragment}: to create or edit a(n) FreeMaterial,
 * - {@link FreeMaterialSetDetailFragment}: to display the details of a(n) FreeMaterial,
 * - {@link FreeMaterialSetListFragment}: to list FreeMaterialSet.
 *
 ...
 * what to do.
 */
public class FreeMaterialSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<FreeMaterial> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link FreeMaterialSetListFragment} is
     * getting instantiated (which will load {@link FreeMaterialSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new FreeMaterialSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable FreeMaterial entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        FreeMaterialSetCreateFragment fragment = new FreeMaterialSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable FreeMaterial entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new FreeMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new FreeMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable FreeMaterial entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link FreeMaterialSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((FreeMaterialSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            FreeMaterialViewModel viewModel = new ViewModelProvider(getActivity()).get(FreeMaterialViewModel.class);
