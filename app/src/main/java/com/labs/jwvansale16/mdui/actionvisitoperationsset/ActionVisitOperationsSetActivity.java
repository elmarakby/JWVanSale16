 ...
 * - {@link ActionVisitOperationsSetCreateFragment}: to create or edit a(n) ActionVisitOperations,
 * - {@link ActionVisitOperationsSetDetailFragment}: to display the details of a(n) ActionVisitOperations,
 * - {@link ActionVisitOperationsSetListFragment}: to list ActionVisitOperationsSet.
 *
 ...
 * what to do.
 */
public class ActionVisitOperationsSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ActionVisitOperations> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ActionVisitOperationsSetListFragment} is
     * getting instantiated (which will load {@link ActionVisitOperationsSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionVisitOperationsSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ActionVisitOperations entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ActionVisitOperationsSetCreateFragment fragment = new ActionVisitOperationsSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ActionVisitOperations entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionVisitOperationsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ActionVisitOperationsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ActionVisitOperations entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ActionVisitOperationsSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ActionVisitOperationsSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ActionVisitOperationsViewModel viewModel = new ViewModelProvider(getActivity()).get(ActionVisitOperationsViewModel.class);
