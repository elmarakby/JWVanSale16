 ...
 * - {@link PricesA906SetCreateFragment}: to create or edit a(n) PricesA906,
 * - {@link PricesA906SetDetailFragment}: to display the details of a(n) PricesA906,
 * - {@link PricesA906SetListFragment}: to list PricesA906Set.
 *
 ...
 * what to do.
 */
public class PricesA906SetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PricesA906> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PricesA906SetListFragment} is
     * getting instantiated (which will load {@link PricesA906SetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA906SetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PricesA906 entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PricesA906SetCreateFragment fragment = new PricesA906SetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PricesA906 entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA906SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PricesA906SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PricesA906 entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PricesA906SetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PricesA906SetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PricesA906ViewModel viewModel = new ViewModelProvider(getActivity()).get(PricesA906ViewModel.class);
