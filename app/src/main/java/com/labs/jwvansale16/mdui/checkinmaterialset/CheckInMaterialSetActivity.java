 ...
 * - {@link CheckInMaterialSetCreateFragment}: to create or edit a(n) CheckInMaterial,
 * - {@link CheckInMaterialSetDetailFragment}: to display the details of a(n) CheckInMaterial,
 * - {@link CheckInMaterialSetListFragment}: to list CheckInMaterialSet.
 *
 ...
 * what to do.
 */
public class CheckInMaterialSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CheckInMaterial> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CheckInMaterialSetListFragment} is
     * getting instantiated (which will load {@link CheckInMaterialSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CheckInMaterialSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CheckInMaterial entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CheckInMaterialSetCreateFragment fragment = new CheckInMaterialSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CheckInMaterial entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CheckInMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CheckInMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CheckInMaterial entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CheckInMaterialSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CheckInMaterialSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CheckInMaterialViewModel viewModel = new ViewModelProvider(getActivity()).get(CheckInMaterialViewModel.class);
