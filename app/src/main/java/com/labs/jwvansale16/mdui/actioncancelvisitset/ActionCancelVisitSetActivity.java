 ...
 * - {@link ActionCancelVisitSetCreateFragment}: to create or edit a(n) ActionCancelVisit,
 * - {@link ActionCancelVisitSetDetailFragment}: to display the details of a(n) ActionCancelVisit,
 * - {@link ActionCancelVisitSetListFragment}: to list ActionCancelVisitSet.
 *
 ...
 * what to do.
 */
public class ActionCancelVisitSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ActionCancelVisit> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ActionCancelVisitSetListFragment} is
     * getting instantiated (which will load {@link ActionCancelVisitSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionCancelVisitSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ActionCancelVisit entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ActionCancelVisitSetCreateFragment fragment = new ActionCancelVisitSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ActionCancelVisit entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionCancelVisitSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ActionCancelVisitSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ActionCancelVisit entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ActionCancelVisitSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ActionCancelVisitSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ActionCancelVisitViewModel viewModel = new ViewModelProvider(getActivity()).get(ActionCancelVisitViewModel.class);
