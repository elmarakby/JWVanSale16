 ...
 * - {@link VisitOperationsHeaderSetCreateFragment}: to create or edit a(n) VisitOperationsHeader,
 * - {@link VisitOperationsHeaderSetDetailFragment}: to display the details of a(n) VisitOperationsHeader,
 * - {@link VisitOperationsHeaderSetListFragment}: to list VisitOperationsHeaderSet.
 *
 ...
 * what to do.
 */
public class VisitOperationsHeaderSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<VisitOperationsHeader> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link VisitOperationsHeaderSetListFragment} is
     * getting instantiated (which will load {@link VisitOperationsHeaderSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new VisitOperationsHeaderSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable VisitOperationsHeader entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        VisitOperationsHeaderSetCreateFragment fragment = new VisitOperationsHeaderSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable VisitOperationsHeader entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new VisitOperationsHeaderSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new VisitOperationsHeaderSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable VisitOperationsHeader entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link VisitOperationsHeaderSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((VisitOperationsHeaderSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            VisitOperationsHeaderViewModel viewModel = new ViewModelProvider(getActivity()).get(VisitOperationsHeaderViewModel.class);
