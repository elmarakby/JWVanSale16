 ...
 * - {@link DriverDetailsSetCreateFragment}: to create or edit a(n) DriverDetails,
 * - {@link DriverDetailsSetDetailFragment}: to display the details of a(n) DriverDetails,
 * - {@link DriverDetailsSetListFragment}: to list DriverDetailsSet.
 *
 ...
 * what to do.
 */
public class DriverDetailsSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<DriverDetails> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link DriverDetailsSetListFragment} is
     * getting instantiated (which will load {@link DriverDetailsSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DriverDetailsSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable DriverDetails entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        DriverDetailsSetCreateFragment fragment = new DriverDetailsSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable DriverDetails entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new DriverDetailsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new DriverDetailsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable DriverDetails entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link DriverDetailsSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((DriverDetailsSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            DriverDetailsViewModel viewModel = new ViewModelProvider(getActivity()).get(DriverDetailsViewModel.class);
