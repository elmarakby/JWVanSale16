 ...
 * - {@link CheckoutMaterialSetCreateFragment}: to create or edit a(n) CheckoutMaterial,
 * - {@link CheckoutMaterialSetDetailFragment}: to display the details of a(n) CheckoutMaterial,
 * - {@link CheckoutMaterialSetListFragment}: to list CheckoutMaterialSet.
 *
 ...
 * what to do.
 */
public class CheckoutMaterialSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CheckoutMaterial> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CheckoutMaterialSetListFragment} is
     * getting instantiated (which will load {@link CheckoutMaterialSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CheckoutMaterialSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CheckoutMaterial entity) {
        switch (eventId) {
...
//                    Intent intent = new Intent(this, EntitySetListActivity.class);
    ...
    private void onCreateNewItem() {
        ...
        CheckoutMaterialSetCreateFragment fragment = new CheckoutMaterialSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CheckoutMaterial entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CheckoutMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CheckoutMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CheckoutMaterial entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CheckoutMaterialSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CheckoutMaterialSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CheckoutMaterialViewModel viewModel = new ViewModelProvider(getActivity()).get(CheckoutMaterialViewModel.class);
