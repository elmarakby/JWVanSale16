 ...
 * - {@link PricesA005SetCreateFragment}: to create or edit a(n) PricesA005,
 * - {@link PricesA005SetDetailFragment}: to display the details of a(n) PricesA005,
 * - {@link PricesA005SetListFragment}: to list PricesA005Set.
 *
 ...
 * what to do.
 */
public class PricesA005SetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PricesA005> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PricesA005SetListFragment} is
     * getting instantiated (which will load {@link PricesA005SetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA005SetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PricesA005 entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PricesA005SetCreateFragment fragment = new PricesA005SetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PricesA005 entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA005SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PricesA005SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PricesA005 entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PricesA005SetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PricesA005SetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PricesA005ViewModel viewModel = new ViewModelProvider(getActivity()).get(PricesA005ViewModel.class);
