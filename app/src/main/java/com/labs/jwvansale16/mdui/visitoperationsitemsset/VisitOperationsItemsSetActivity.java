 ...
 * - {@link VisitOperationsItemsSetCreateFragment}: to create or edit a(n) VisitOperationsItems,
 * - {@link VisitOperationsItemsSetDetailFragment}: to display the details of a(n) VisitOperationsItems,
 * - {@link VisitOperationsItemsSetListFragment}: to list VisitOperationsItemsSet.
 *
 ...
 * what to do.
 */
public class VisitOperationsItemsSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<VisitOperationsItems> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link VisitOperationsItemsSetListFragment} is
     * getting instantiated (which will load {@link VisitOperationsItemsSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new VisitOperationsItemsSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable VisitOperationsItems entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        VisitOperationsItemsSetCreateFragment fragment = new VisitOperationsItemsSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable VisitOperationsItems entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new VisitOperationsItemsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new VisitOperationsItemsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable VisitOperationsItems entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link VisitOperationsItemsSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((VisitOperationsItemsSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            VisitOperationsItemsViewModel viewModel = new ViewModelProvider(getActivity()).get(VisitOperationsItemsViewModel.class);
