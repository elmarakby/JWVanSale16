...
import com.labs.jwvansale16.archcomp.SingleLiveEvent;

import com.labs.jwvansale16.repository.OperationResult.Operation;
...
public class Repository<T extends EntityValue> {
     ...
     * OData service
     */
    private ZGW_VANSALE_SRV_Entities zGW_VANSALE_SRV_Entities;
     ...
     * @param zGW_VANSALE_SRV_Entities - OData service
     * @param entitySet - the entity set this repository provides access for
     */
    public Repository(@NonNull ZGW_VANSALE_SRV_Entities zGW_VANSALE_SRV_Entities, @NonNull EntitySet entitySet, @Nullable Property orderByProperty) {
        this.zGW_VANSALE_SRV_Entities = zGW_VANSALE_SRV_Entities;
    ...
    public void read() {
        ...
        zGW_VANSALE_SRV_Entities.executeQueryAsync(dataQuery,
            result -> {
    ...
    public void read(EntityValue parent, String navigationPropertyName) {
        ...
        zGW_VANSALE_SRV_Entities.loadPropertyAsync(navigationProperty, parent, dataQuery,
            () -> {
    ...
    public void create(@NonNull T newEntity, @NonNull StreamBase media) {
        if (newEntity.getEntityType().isMedia()) {
            zGW_VANSALE_SRV_Entities.createMediaAsync(newEntity, media,
                () -> {
    ...
    public void create(@NonNull T newEntity) {
        ...
        zGW_VANSALE_SRV_Entities.createEntityAsync(newEntity,
            () -> {
                insertToCache(newEntity, entities);
                if (relatedEntities.size() > 0) {
                    insertToCache(newEntity, relatedEntities);
    ...
    public void update(@NonNull T updateEntity) {
        zGW_VANSALE_SRV_Entities.updateEntityAsync(updateEntity,
            () -> {
    ...
    public void delete(@NonNull List<T> deleteEntities) {
        ...
        zGW_VANSALE_SRV_Entities.applyChangesAsync(deleteChangeSet,
            () -> {
    ...
    public void downloadMedia(@NonNull T entity, Action1<byte[]> successHandler,
        ...
        zGW_VANSALE_SRV_Entities.downloadMediaAsync(entity,
