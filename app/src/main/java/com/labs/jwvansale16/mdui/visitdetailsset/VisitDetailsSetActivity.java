 ...
 * - {@link VisitDetailsSetCreateFragment}: to create or edit a(n) VisitDetails,
 * - {@link VisitDetailsSetDetailFragment}: to display the details of a(n) VisitDetails,
 * - {@link VisitDetailsSetListFragment}: to list VisitDetailsSet.
 *
 ...
 * what to do.
 */
public class VisitDetailsSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<VisitDetails> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link VisitDetailsSetListFragment} is
     * getting instantiated (which will load {@link VisitDetailsSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new VisitDetailsSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable VisitDetails entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        VisitDetailsSetCreateFragment fragment = new VisitDetailsSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable VisitDetails entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new VisitDetailsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new VisitDetailsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable VisitDetails entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link VisitDetailsSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((VisitDetailsSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            VisitDetailsViewModel viewModel = new ViewModelProvider(getActivity()).get(VisitDetailsViewModel.class);
