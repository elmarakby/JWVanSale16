 ...
 * - {@link CustomerVisitPlanSetCreateFragment}: to create or edit a(n) CustomerVisitPlan,
 * - {@link CustomerVisitPlanSetDetailFragment}: to display the details of a(n) CustomerVisitPlan,
 * - {@link CustomerVisitPlanSetListFragment}: to list CustomerVisitPlanSet.
 *
 ...
 * what to do.
 */
public class CustomerVisitPlanSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CustomerVisitPlan> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CustomerVisitPlanSetListFragment} is
     * getting instantiated (which will load {@link CustomerVisitPlanSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CustomerVisitPlanSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    private void onCreateNewItem() {
        ...
        CustomerVisitPlanSetCreateFragment fragment = new CustomerVisitPlanSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CustomerVisitPlan entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CustomerVisitPlanSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CustomerVisitPlanSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CustomerVisitPlan entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CustomerVisitPlanSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CustomerVisitPlanSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CustomerVisitPlanViewModel viewModel = new ViewModelProvider(getActivity()).get(CustomerVisitPlanViewModel.class);
