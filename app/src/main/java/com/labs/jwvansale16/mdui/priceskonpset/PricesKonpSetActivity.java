 ...
 * - {@link PricesKonpSetCreateFragment}: to create or edit a(n) PricesKonp,
 * - {@link PricesKonpSetDetailFragment}: to display the details of a(n) PricesKonp,
 * - {@link PricesKonpSetListFragment}: to list PricesKonpSet.
 *
 ...
 * what to do.
 */
public class PricesKonpSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PricesKonp> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PricesKonpSetListFragment} is
     * getting instantiated (which will load {@link PricesKonpSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesKonpSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PricesKonp entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PricesKonpSetCreateFragment fragment = new PricesKonpSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PricesKonp entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesKonpSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PricesKonpSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PricesKonp entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PricesKonpSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PricesKonpSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PricesKonpViewModel viewModel = new ViewModelProvider(getActivity()).get(PricesKonpViewModel.class);
