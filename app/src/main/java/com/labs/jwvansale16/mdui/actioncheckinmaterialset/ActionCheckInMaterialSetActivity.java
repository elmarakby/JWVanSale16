 ...
 * - {@link ActionCheckInMaterialSetCreateFragment}: to create or edit a(n) ActionCheckInMaterial,
 * - {@link ActionCheckInMaterialSetDetailFragment}: to display the details of a(n) ActionCheckInMaterial,
 * - {@link ActionCheckInMaterialSetListFragment}: to list ActionCheckInMaterialSet.
 *
 ...
 * what to do.
 */
public class ActionCheckInMaterialSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<ActionCheckInMaterial> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link ActionCheckInMaterialSetListFragment} is
     * getting instantiated (which will load {@link ActionCheckInMaterialSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionCheckInMaterialSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable ActionCheckInMaterial entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        ActionCheckInMaterialSetCreateFragment fragment = new ActionCheckInMaterialSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable ActionCheckInMaterial entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new ActionCheckInMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new ActionCheckInMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable ActionCheckInMaterial entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link ActionCheckInMaterialSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((ActionCheckInMaterialSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            ActionCheckInMaterialViewModel viewModel = new ViewModelProvider(getActivity()).get(ActionCheckInMaterialViewModel.class);
