 ...
 * - {@link PricesA905SetCreateFragment}: to create or edit a(n) PricesA905,
 * - {@link PricesA905SetDetailFragment}: to display the details of a(n) PricesA905,
 * - {@link PricesA905SetListFragment}: to list PricesA905Set.
 *
 ...
 * what to do.
 */
public class PricesA905SetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PricesA905> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PricesA905SetListFragment} is
     * getting instantiated (which will load {@link PricesA905SetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA905SetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PricesA905 entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PricesA905SetCreateFragment fragment = new PricesA905SetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PricesA905 entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA905SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PricesA905SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PricesA905 entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PricesA905SetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PricesA905SetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PricesA905ViewModel viewModel = new ViewModelProvider(getActivity()).get(PricesA905ViewModel.class);
