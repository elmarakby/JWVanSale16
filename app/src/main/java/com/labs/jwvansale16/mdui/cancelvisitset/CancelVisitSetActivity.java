 ...
 * - {@link CancelVisitSetCreateFragment}: to create or edit a(n) CancelVisit,
 * - {@link CancelVisitSetDetailFragment}: to display the details of a(n) CancelVisit,
 * - {@link CancelVisitSetListFragment}: to list CancelVisitSet.
 *
 ...
 * what to do.
 */
public class CancelVisitSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<CancelVisit> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CancelVisitSetListFragment} is
     * getting instantiated (which will load {@link CancelVisitSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CancelVisitSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable CancelVisit entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CancelVisitSetCreateFragment fragment = new CancelVisitSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable CancelVisit entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CancelVisitSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CancelVisitSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable CancelVisit entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CancelVisitSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CancelVisitSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CancelVisitViewModel viewModel = new ViewModelProvider(getActivity()).get(CancelVisitViewModel.class);
