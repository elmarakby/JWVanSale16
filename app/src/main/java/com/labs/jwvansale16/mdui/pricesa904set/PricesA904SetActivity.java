 ...
 * - {@link PricesA904SetCreateFragment}: to create or edit a(n) PricesA904,
 * - {@link PricesA904SetDetailFragment}: to display the details of a(n) PricesA904,
 * - {@link PricesA904SetListFragment}: to list PricesA904Set.
 *
 ...
 * what to do.
 */
public class PricesA904SetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PricesA904> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PricesA904SetListFragment} is
     * getting instantiated (which will load {@link PricesA904SetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA904SetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PricesA904 entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PricesA904SetCreateFragment fragment = new PricesA904SetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PricesA904 entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA904SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PricesA904SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PricesA904 entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PricesA904SetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PricesA904SetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PricesA904ViewModel viewModel = new ViewModelProvider(getActivity()).get(PricesA904ViewModel.class);
