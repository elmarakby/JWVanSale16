 ...
 * - {@link PricesA908SetCreateFragment}: to create or edit a(n) PricesA908,
 * - {@link PricesA908SetDetailFragment}: to display the details of a(n) PricesA908,
 * - {@link PricesA908SetListFragment}: to list PricesA908Set.
 *
 ...
 * what to do.
 */
public class PricesA908SetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<PricesA908> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link PricesA908SetListFragment} is
     * getting instantiated (which will load {@link PricesA908SetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA908SetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable PricesA908 entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        PricesA908SetCreateFragment fragment = new PricesA908SetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable PricesA908 entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new PricesA908SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new PricesA908SetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable PricesA908 entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link PricesA908SetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((PricesA908SetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            PricesA908ViewModel viewModel = new ViewModelProvider(getActivity()).get(PricesA908ViewModel.class);
