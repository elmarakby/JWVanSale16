 ...
 * - {@link TotalMaterialSetCreateFragment}: to create or edit a(n) TotalMaterial,
 * - {@link TotalMaterialSetDetailFragment}: to display the details of a(n) TotalMaterial,
 * - {@link TotalMaterialSetListFragment}: to list TotalMaterialSet.
 *
 ...
 * what to do.
 */
public class TotalMaterialSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<TotalMaterial> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link TotalMaterialSetListFragment} is
     * getting instantiated (which will load {@link TotalMaterialSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TotalMaterialSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable TotalMaterial entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        TotalMaterialSetCreateFragment fragment = new TotalMaterialSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable TotalMaterial entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new TotalMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new TotalMaterialSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable TotalMaterial entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link TotalMaterialSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((TotalMaterialSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            TotalMaterialViewModel viewModel = new ViewModelProvider(getActivity()).get(TotalMaterialViewModel.class);
