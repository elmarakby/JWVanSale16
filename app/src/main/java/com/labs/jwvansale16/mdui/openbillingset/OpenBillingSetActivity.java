 ...
 * - {@link OpenBillingSetCreateFragment}: to create or edit a(n) OpenBilling,
 * - {@link OpenBillingSetDetailFragment}: to display the details of a(n) OpenBilling,
 * - {@link OpenBillingSetListFragment}: to list OpenBillingSet.
 *
 ...
 * what to do.
 */
public class OpenBillingSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<OpenBilling> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link OpenBillingSetListFragment} is
     * getting instantiated (which will load {@link OpenBillingSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OpenBillingSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable OpenBilling entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        OpenBillingSetCreateFragment fragment = new OpenBillingSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable OpenBilling entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new OpenBillingSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new OpenBillingSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable OpenBilling entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link OpenBillingSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((OpenBillingSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            OpenBillingViewModel viewModel = new ViewModelProvider(getActivity()).get(OpenBillingViewModel.class);
