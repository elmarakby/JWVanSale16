 ...
 * - {@link CollectionsSetCreateFragment}: to create or edit a(n) Collections,
 * - {@link CollectionsSetDetailFragment}: to display the details of a(n) Collections,
 * - {@link CollectionsSetListFragment}: to list CollectionsSet.
 *
 ...
 * what to do.
 */
public class CollectionsSetActivity extends AppCompatActivity implements InterfacedFragment.InterfacedFragmentListener<Collections> {
    ...
    /**
     * In this lifecycle state, some instance state variables gets loaded, {@link CollectionsSetListFragment} is
     * getting instantiated (which will load {@link CollectionsSetDetailFragment} if needed), visibilities of
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CollectionsSetListFragment(), UIConstants.LIST_FRAGMENT_TAG)
                .commit();
        }
    ...
    */
    ...
    @Override
    public void onFragmentStateChange(int eventId, @Nullable Collections entity) {
        switch (eventId) {
    ...
    private void onCreateNewItem() {
        ...
        CollectionsSetCreateFragment fragment = new CollectionsSetCreateFragment();
     ...
     */
    private void onItemClicked(@Nullable Collections entity) {
        if( !isMasterDetailView ) {
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.masterFrame, new CollectionsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
            ...
            if( detail == null && entity != null ) {
                getSupportFragmentManager().beginTransaction()
                    .replace(R.id.detailFrame, new CollectionsSetDetailFragment(), UIConstants.DETAIL_FRAGMENT_TAG)
                    .commit();
                return;
            }
     ...
     */
    private void onEditItem(@Nullable Collections entity) {
        Bundle arguments = new Bundle();
    ...
    /**
     * Shows an AlertDialog when user wants to leave {@link CollectionsSetCreateFragment}.
     */
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            ...
            builder.setPositiveButton(R.string.before_navigation_dialog_positive_button, (dialog, which) -> {
                ((CollectionsSetActivity)getActivity()).onFragmentStateChange(UIConstants.EVENT_BACK_NAVIGATION_CONFIRMED, null);
            });
    ...
    public static class DeleteConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(getActivity(), R.style.AlertDialogStyle));
            CollectionsViewModel viewModel = new ViewModelProvider(getActivity()).get(CollectionsViewModel.class);
